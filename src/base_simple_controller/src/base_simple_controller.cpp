...
//    tf_odom_pub_->msg_.transforms[0].transform.translation.y = 0.0;
//    tf_odom_pub_->msg_.transforms[0].transform.translation.x = 0.0;
//	tf_odom_pub_->msg_.transforms[0].transform.rotation.x = 0.0;
//	tf_odom_pub_->msg_.transforms[0].transform.rotation.y = 0.0;
//	tf_odom_pub_->msg_.transforms[0].transform.rotation.z = 0.0;
//	tf_odom_pub_->msg_.transforms[0].transform.rotation.w = 0.0;
