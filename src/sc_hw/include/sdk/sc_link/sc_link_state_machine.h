#ifndef SC_LINK_STATE_MACHINE_H
#define SC_LINK_STATE_MACHINE_H

#include "stdio.h"
#include "sc_link_platform.h"

//limite one message's size
static const unsigned short int MESSAGE_BUFER_SIZE = 120;
typedef struct SCMessage{
...
public:
    ...
    void sendMessage(const SCMessage* tx_message_);
    SCMessage rx_message ,  tx_message;
