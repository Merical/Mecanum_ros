...
private:
    ...
    inline void writeBufferUpdate()
    {
        ...
        hf_hw_.getRobotAbstract()->expect_robot_speed.x = x_cmd_*100;
//        hf_hw_.getRobotAbstract()->expect_robot_speed.x = 20;
        hf_hw_.getRobotAbstract()->expect_robot_speed.y = -y_cmd_*100;
        hf_hw_.getRobotAbstract()->expect_robot_speed.z = theta_cmd_*40;
