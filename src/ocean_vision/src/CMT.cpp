...
//    cout << "LCH: the points_active shape is " << points_active.size() << endl;
    points_active = points_fused;
    classes_active = classes_fused;

    if (points_active.size() > 50){has_result = true;}
    else{has_result = false;}
...
//    points_active.clear();
//    classes_active.clear();
//    cout << "LCH: cmt:process frame done!" << endl;
