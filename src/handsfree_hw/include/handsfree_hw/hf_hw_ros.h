...
//        hf_hw_.getRobotAbstract()->expect_robot_speed.x = 20;
        ...
        hf_hw_.getRobotAbstract()->expect_robot_speed.z = theta_cmd_/3.14*180/theta_vel_top*100;
    ...
    inline void readBufferUpdateFirst()
    {
        ...
        theta_vel_ =  hf_hw_.getRobotAbstract()->measure_robot_speed.z/180*3.14;

        x_     = hf_hw_.getRobotAbstract()->measure_global_coordinate.x;
        y_     = hf_hw_.getRobotAbstract()->measure_global_coordinate.y;
        theta_ = hf_hw_.getRobotAbstract()->measure_global_coordinate.z/180*3.14;

        last_x_raw = x_;  // m
        last_y_raw = y_;
        last_theta_raw = theta_;
...
//        theta_ = hf_hw_.getRobotAbstract()->measure_global_coordinate.z/180*3.14;
        theta_raw = hf_hw_.getRobotAbstract()->measure_global_coordinate.z/180*3.14;
