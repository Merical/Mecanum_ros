...
private:
    ...
    inline void writeBufferUpdate()
    {
        ...
        hf_hw_.getRobotAbstract()->expect_motor_speed.servo4 = wheel_cmd_[3];

        hf_hw_.getRobotAbstract()->expect_robot_speed.x = x_cmd_*100/x_vel_top;
//        hf_hw_.getRobotAbstract()->expect_robot_speed.x = 20;
        hf_hw_.getRobotAbstract()->expect_robot_speed.y = y_cmd_*100/y_vel_top;
        hf_hw_.getRobotAbstract()->expect_robot_speed.z = theta_cmd_/M_PI*180/theta_vel_top*100;

        hf_hw_.getRobotAbstract()->expect_intf_mode.intf = intf_state_ros_sub.robot_intf;
        hf_hw_.getRobotAbstract()->expect_intf_mode.mode = intf_state_ros_sub.robot_mode;
    ...
    {
        plate_type_ = hf_hw_.getRobotAbstract()->module_config.plate_type;
        imu_num_    = hf_hw_.getRobotAbstract()->module_config.imu_num;
        track_num_  = hf_hw_.getRobotAbstract()->module_config.track_num;
        ultra_num_  = hf_hw_.getRobotAbstract()->module_config.ultra_num;
        arm_num_    = hf_hw_.getRobotAbstract()->module_config.arm_num;
        head_num_   = hf_hw_.getRobotAbstract()->module_config.head_num;
        serv_num_   = hf_hw_.getRobotAbstract()->module_config.serv_num;

        x_vel_      = hf_hw_.getRobotAbstract()->measure_robot_speed.y;
        y_vel_      = hf_hw_.getRobotAbstract()->measure_robot_speed.x;
...
//        last_theta_raw  = theta_raw;
        ...
        roll_imu_init_raw    = hf_hw_.getRobotAbstract()->magnetic_fusion.roll/180*M_PI;
...
*/
        ...
        /*****************************************************imu_quat********************************************/
        yaw_imu_current_raw     = hf_hw_.getRobotAbstract()->magnetic_fusion.yaw/180*M_PI;
        pitch_imu_current_raw   = hf_hw_.getRobotAbstract()->magnetic_fusion.pitch/180*M_PI;
        roll_imu_current_raw    = hf_hw_.getRobotAbstract()->magnetic_fusion.roll/180*M_PI;
        ...
        imu_data.linear_acceleration.x = hf_hw_.getRobotAbstract()->magnetic_fusion.linear_acc_x;
        imu_data.linear_acceleration.y = hf_hw_.getRobotAbstract()->magnetic_fusion.linear_acc_y;
        imu_data.linear_acceleration.z = hf_hw_.getRobotAbstract()->magnetic_fusion.linear_acc_z;
        imu_data.angular_velocity.x = hf_hw_.getRobotAbstract()->magnetic_fusion.angular_vel_x;
        imu_data.angular_velocity.y = hf_hw_.getRobotAbstract()->magnetic_fusion.angular_vel_y;
        imu_data.angular_velocity.z = hf_hw_.getRobotAbstract()->magnetic_fusion.angular_vel_z;
