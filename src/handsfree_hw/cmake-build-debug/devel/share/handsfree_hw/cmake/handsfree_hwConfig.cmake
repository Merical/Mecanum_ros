...
if(NOT "/home/lishenghao/ros_workspace/SC0_ws/src/handsfree_hw/include " STREQUAL " ")
  set(handsfree_hw_INCLUDE_DIRS "")
  set(_include_dirs "/home/lishenghao/ros_workspace/SC0_ws/src/handsfree_hw/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'handsfree_hw' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lishenghao/ros_workspace/SC0_ws/src/handsfree_hw/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lishenghao/ros_workspace/SC0_ws/src/handsfree_hw/cmake-build-debug/devel/lib;/home/lishenghao/ros_workspace/my_handsfree_ws/devel/lib;/opt/ros/kinetic/lib)
